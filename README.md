...
- 👩‍🎓 **Formación**: En constante aprendizaje sobre análisis de datos, visualización y modelos generativos.
- 🤖 **Intereses**: Data Science, modelos generativos (Generative AI), machine learning y todo lo relacionado con los datos y la inteligencia artificial.
- 🌍 **Objetivo profesional**: Encontrar el lugar perfecto para crecer como profesional y contribuir con ideas frescas e innovadoras.

## 📫 ¿Quieres conectar conmigo?  
No dudes en visitarme en GitHub o enviarme un mensaje. Estoy abierta a colaboraciones, mentorías y oportunidades laborales emocionantes. 🚀

---
Este espacio está en constante evolución, al igual que yo. ¡Gracias por visitar mi perfil!